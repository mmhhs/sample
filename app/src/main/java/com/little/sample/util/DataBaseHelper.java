...
public class DataBaseHelper extends OrmLiteSqliteOpenHelper
{
  ...
  private Dao<VisitSampleDataEntity, String> userInfoDao;
  ...
  public void onCreate(SQLiteDatabase paramSQLiteDatabase, ConnectionSource paramConnectionSource)
  {
    try
    {
      ...
      TableUtils.createTableIfNotExists(paramConnectionSource, VisitSampleDataEntity.class);
  ...
  public void onUpgrade(SQLiteDatabase paramSQLiteDatabase, ConnectionSource paramConnectionSource, int paramInt1, int paramInt2)
  {
    try {
      //当数据库版本变化时，更新数据库
      TableUtils.dropTable(paramConnectionSource, VisitSampleDataEntity.class, true);
  ...
  public Dao<VisitSampleDataEntity, String> getUserInfoDao()
          throws SQLException
  {
    if (this.userInfoDao == null)
      this.userInfoDao = getDao(VisitSampleDataEntity.class);
