...
public class PermissionUtil {
    ...
    public static void showPermissionDialog(final Context context, View view) {
        PopupDialog popupDialog = new PopupDialog(context);
        popupDialog.setDialogTitle("帮助");
        popupDialog.setConfirmStr("设置");
        popupDialog.setCancelStr("退出应用");
        popupDialog.showTipDialog(view, "当前应用缺少定位、读写文件权限\n" +
                "请点击“设置”-“权限”-打开所需权限");
