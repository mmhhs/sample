    ...
    protected int onStart(Intent intent, int flags, int startId) {
        try {
            ...
            try {
                ...
                startService(new Intent(getApplication(), KeepWatchService.class));
            } catch (Exception e) {
                e.printStackTrace();
            }
            ...
            getPackageManager().setComponentEnabledSetting(new ComponentName(getPackageName(), KeepWatchService.class.getName()),
