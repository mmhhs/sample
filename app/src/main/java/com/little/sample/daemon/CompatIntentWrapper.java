...
public class CompatIntentWrapper {
    ...
    protected static List<CompatIntentWrapper> sCompatIntentWrapperList;

    public static List<CompatIntentWrapper> getIntentWrapperList() {
        try {
            if (sCompatIntentWrapperList == null) {

                if (!DaemonHelper.sInitialized) return new ArrayList<>();

                sCompatIntentWrapperList = new ArrayList<>();

                //Android 6.0+ Doze 模式
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
                    PowerManager pm = (PowerManager) DaemonHelper.sApp.getSystemService(Context.POWER_SERVICE);
                    boolean ignoringBatteryOptimizations = pm.isIgnoringBatteryOptimizations(DaemonHelper.sApp.getPackageName());
                    if (!ignoringBatteryOptimizations) {
                        Intent dozeIntent = new Intent(Settings.ACTION_REQUEST_IGNORE_BATTERY_OPTIMIZATIONS);
                        dozeIntent.setData(Uri.parse("package:" + DaemonHelper.sApp.getPackageName()));
                        sCompatIntentWrapperList.add(new CompatIntentWrapper(dozeIntent, DOZE));
                    }
                }
                ...
                sCompatIntentWrapperList.add(new CompatIntentWrapper(huaweiIntent, HUAWEI));
                ...
                sCompatIntentWrapperList.add(new CompatIntentWrapper(huaweiGodIntent, HUAWEI_GOD));
                ...
                sCompatIntentWrapperList.add(new CompatIntentWrapper(xiaomiIntent, XIAOMI));
                ...
                sCompatIntentWrapperList.add(new CompatIntentWrapper(xiaomiGodIntent, XIAOMI_GOD));

                //三星 5.0/5.1 自启动应用程序管理
                Intent samsungLIntent = DaemonHelper.sApp.getPackageManager().getLaunchIntentForPackage("com.samsung.android.sm");
                if (samsungLIntent != null) sCompatIntentWrapperList.add(new CompatIntentWrapper(samsungLIntent, SAMSUNG_L));
                ...
                sCompatIntentWrapperList.add(new CompatIntentWrapper(samsungMIntent, SAMSUNG_M));

                //魅族 自启动管理
                Intent meizuIntent = new Intent("com.meizu.safe.security.SHOW_APPSEC");
                meizuIntent.addCategory(Intent.CATEGORY_DEFAULT);
                meizuIntent.putExtra("packageName", DaemonHelper.sApp.getPackageName());
                sCompatIntentWrapperList.add(new CompatIntentWrapper(meizuIntent, MEIZU));
                ...
                sCompatIntentWrapperList.add(new CompatIntentWrapper(meizuGodIntent, MEIZU_GOD));
                ...
                sCompatIntentWrapperList.add(new CompatIntentWrapper(oppoIntent, OPPO));
                ...
                sCompatIntentWrapperList.add(new CompatIntentWrapper(oppoOldIntent, OPPO_OLD));
                ...
                sCompatIntentWrapperList.add(new CompatIntentWrapper(vivoGodIntent, VIVO_GOD));
                ...
                sCompatIntentWrapperList.add(new CompatIntentWrapper(gioneeIntent, GIONEE));
                ...
                sCompatIntentWrapperList.add(new CompatIntentWrapper(letvIntent, LETV));
                ...
                sCompatIntentWrapperList.add(new CompatIntentWrapper(letvGodIntent, LETV_GOD));
                ...
                sCompatIntentWrapperList.add(new CompatIntentWrapper(coolpadIntent, COOLPAD));
                ...
                sCompatIntentWrapperList.add(new CompatIntentWrapper(lenovoIntent, LENOVO));
                ...
                sCompatIntentWrapperList.add(new CompatIntentWrapper(lenovoGodIntent, LENOVO_GOD));
                ...
                sCompatIntentWrapperList.add(new CompatIntentWrapper(zteIntent, ZTE));
                ...
                sCompatIntentWrapperList.add(new CompatIntentWrapper(zteGodIntent, ZTE_GOD));
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
        return sCompatIntentWrapperList;
    }
    ...
    protected static String getApplicationName() {
        try {
            if (sApplicationName == null) {
                if (!DaemonHelper.sInitialized) return "";
                PackageManager pm;
                ApplicationInfo ai;
                try {
                    pm = DaemonHelper.sApp.getPackageManager();
                    ai = pm.getApplicationInfo(DaemonHelper.sApp.getPackageName(), 0);
                    sApplicationName = pm.getApplicationLabel(ai).toString();
                } catch (PackageManager.NameNotFoundException e) {
                    e.printStackTrace();
                    sApplicationName = DaemonHelper.sApp.getPackageName();
                }
            }
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public static void whiteListMatters(final Activity a, String reason) {
        try {
            ...
            List<CompatIntentWrapper> compatIntentWrapperList = getIntentWrapperList();
            for (final CompatIntentWrapper iw : compatIntentWrapperList) {
    ...
    protected CompatIntentWrapper(Intent intent, int type) {
        this.intent = intent;
        this.type = type;
    }
    ...
    protected boolean doesActivityExists() {
        try {
            ...
            PackageManager pm = DaemonHelper.sApp.getPackageManager();
