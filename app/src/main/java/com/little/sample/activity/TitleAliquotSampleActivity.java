...
public class TitleAliquotSampleActivity extends FragmentActivity {
    ...
    public void init() {
        ...
        initFragment();
        setTitles();
        activityTitleCenterSampleTitlePagerLayout.initData(TitlePagerLayout.TITLE_MODE.WEIGHT, titleItemList, activityTitleCenterSampleViewPager, screenFlag);
