...
public class RoundProgressBar extends View {
    ...
    public RoundProgressBar(Context context, AttributeSet attrs, int defStyle) {
        ...
        max = mTypedArray.getInteger(R.styleable.RoundProgressBar_roundMax, 360);
        textIsDisplayable = mTypedArray.getBoolean(R.styleable.RoundProgressBar_roundTextIsDisplayable, true);
