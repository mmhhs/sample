package com.little.sample.view;
...
public class PageIndicatorView extends View {
    ...
    private Drawable indicatorDefaultDrawable;// 指示点默认图片
    private Drawable indicatorSelectDrawable;// 指示点选中图片
    ...
    private void init(AttributeSet attrs, int defStyle) {
        ...
        if (a.hasValue(R.styleable.PageIndicatorView_indicatorDefaultDrawable)) {
            indicatorDefaultDrawable = a.getDrawable(R.styleable.PageIndicatorView_indicatorDefaultDrawable);
            indicatorDefaultDrawable.setCallback(this);
        }

        if (a.hasValue(R.styleable.PageIndicatorView_indicatorSelectDrawable)) {
            indicatorSelectDrawable = a.getDrawable(R.styleable.PageIndicatorView_indicatorSelectDrawable);
            indicatorSelectDrawable.setCallback(this);
        }
