...
#如果用到Gson/jackson解析包的，直接添加下面这几行就能成功混淆，不然会报错
#gson
#-libraryjars libs/jackson-core-master.jar
#-dontwarn com.fasterxml.jackson.**
-keep class com.fasterxml.jackson.** {*;}
#-dontwarn com.duostec.utils.**
-keep class com.duostec.utils.** {*;}
...
-keep class com.little.sample.model.** {*;}
-keep class com.little.visit.model.** {*;}
