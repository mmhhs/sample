...
public class ChoiceBorderView extends View {
    ...
    private boolean IF_SCANNING_SHOW = false;//是否正在缩放
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (MOVE_OR_ZOOM_STATE) {
                    ...
                    for (int i = 0; i < four_corner_coordinate_positions.length; i++) {
                        ...
                        //更新回调接口
                        onImageDetailsSizeChanggedl.onBorderSizeChange(
    ...
    public OnImageDetailsSizeChange onImageDetailsSizeChanggedl;

    public void setonImageDetailsSizeChangged(OnImageDetailsSizeChange OnImageDetailsSizeChange) {
        this.onImageDetailsSizeChanggedl = OnImageDetailsSizeChange;
    }
}